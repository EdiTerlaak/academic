...
Students and teachers agree on one thing: their dislike of tests. Students get stressed out and teachers dislike grading. According to a growing movement among researchers of education, this image is unfortunate, because they think that taking a test after learning improves the score on a subsequent test. This is called the testing effect but is also known as the retrieval effect. They therefore aim to disassociate testing from evaluation and aim to rebrand it as a learning tool. 
